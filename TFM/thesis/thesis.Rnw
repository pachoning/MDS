...
\Cref{chap:sim} we provide more details.
...
\Cref{div_conquer_corr}. All of them have the same shape no matter what
...
The remaining plots are in \Cref{fast_corr}.
...
The remaining plots are in \Cref{gower_corr}.
...
%    \caption{Correlation for $n = 3000$ and MDS Divide and conquer algorithm}
...
%    \caption{Correlation for $n = 5000$ and MDS Divide and conquer algorithm}
...
%    \caption{Correlation for $n = 10000$ and MDS Divide and conquer algorithm}
...
%    \caption{Correlation for $n = 100000$ and MDS Divide and conquer algorithm}
...
%    \caption{Correlation for $n = 1000000$ and MDS Divide and conquer algorithm}
...
%    \caption{Correlation for $n = 3000$ and MDS Fast algorithm.}
...
%    \caption{Correlation for $n = 5000$ and MDS Fast algorithm.}
...
%    \caption{Correlation for $n = 10000$ and MDS Fast algorithm.}
...
%    \caption{Correlation for $n = 100000$ and MDS Fast algorithm.}
...
%    \caption{Correlation for $n = 1000000$ and MDS Fast algorithm.}
...
%%% Pasar el spell checker in latex
%%% cambiar lo de la recursidad
