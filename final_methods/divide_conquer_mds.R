...
#main_divide_conquer_mds <- function(idx, x, x_sample_1, k, original_mds_sample_1, ...) {
main_divide_conquer_mds <- function(idx, x, x_sample_1, k, original_mds_sample_1) {  
  # Filter the matrix
  ...
  # Perform MDS
  #mds_all <- classical_mds(x = x_join_sample_1, k = k, ...)
  mds_all <- classical_mds(x = x_join_sample_1, k = k)
...
divide_conquer_mds <- function(x, l, tie, k, n_cores) {
